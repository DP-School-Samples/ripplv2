...
const rewards: Reward[] = [
  { id: 'r1', name: 'Bamboo Toothbrush Set', description: '4-pack biodegradable bamboo toothbrushes', cost: 100, level: 1, image: '', Icon: Leaf, gradient: 'from-oasis-400 to-oasis-500', color: 'text-oasis-400' },
  { id: 'r2', name: 'Reusable Shopping Bag', description: 'Foldable organic cotton tote bag', cost: 150, level: 2, image: '', Icon: ShoppingBag, gradient: 'from-oasis-300 to-gulf-400', color: 'text-oasis-300' },
  { id: 'r3', name: 'Beach Cleanup Kit', description: 'Gloves, bags, and tools for a cleanup', cost: 200, level: 3, image: '', Icon: Recycle, gradient: 'from-gulf-400 to-gulf-500', color: 'text-gulf-400' },
  { id: 'r4', name: 'Reusable Water Bottle', description: 'Stainless steel, 750ml insulated bottle', cost: 300, level: 4, image: '', Icon: Droplets, gradient: 'from-gulf-300 to-oasis-400', color: 'text-gulf-300' },
  { id: 'r5', name: 'Plant a Mangrove Tree', description: 'One mangrove planted in the UAE', cost: 500, level: 5, image: '', Icon: TreePine, gradient: 'from-oasis-500 to-oasis-600', color: 'text-oasis-500' },
  { id: 'r6', name: 'Solar Phone Charger', description: 'Portable 10W solar panel charger', cost: 1000, level: 6, image: '', Icon: Zap, gradient: 'from-dune-400 to-ember-400', color: 'text-dune-400' },
  { id: 'r7', name: 'Carbon Offset (100 kg)', description: 'Certified carbon offset certificate', cost: 2000, level: 8, image: '', Icon: Shield, gradient: 'from-oasis-400 to-dune-400', color: 'text-oasis-400' },
  { id: 'r8', name: 'Year Supply of Seeds', description: '12 packs of native wildflower seeds', cost: 5000, level: 10, image: '', Icon: Sparkles, gradient: 'from-ember-400 to-dune-300', color: 'text-ember-400' },
]
          ...
          <div className={`rounded-2xl border border-border bg-surface-raised/60 backdrop-blur-sm p-6 text-center`}>
            ...
            {redeemed.includes(selectedReward.id) ? (
              ...
              <div className="text-center">
                ...
                <p className="font-mono text-[9px] text-text-muted">You're level {level} — keep going!</p>
              </div>
